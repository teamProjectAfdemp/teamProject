...
//            prest.setTimestamp(4,route.getDep_time());
//            prest.setTimestamp(5,route.getAr_time());
    ...
    public HashMap<Integer, Route> selectAllRoutes() {
        ...
        return getRoutesfromQuery(query);
    }
    
    public HashMap<Integer, Route> getRoutesfromQuery(String query) {
...
//            route.setDep_time( (Timestamp) row.get("dep_time"));
//            route.setAr_time( (Timestamp) row.get("ar_time") );
