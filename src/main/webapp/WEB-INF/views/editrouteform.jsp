        ...
        <form action="/updateroute" method="POST" modelAttribute="route" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type='date' class="form-control" id='deptime' name='dep_time' placeholder="${fn:escapeXml(routeToEdit.dep_time)}" value="${fn:escapeXml(routeToEdit.dep_time)}" required>

                </div>
                <div class="form-group col-md-6">
                    <label id='ar-field'><i class="far fa-calendar-alt"></i> Arrival<br></label>
                    <input type='date' class="form-control" id='artime'  name='ar_time' placeholder="${fn:escapeXml(routeToEdit.ar_time)}" value="${fn:escapeXml(routeToEdit.ar_time)}" required>
