...
public class ParticipantsDAO extends Database implements ParticipantDAOinterface{

    public static ParticipantsDAO participantDAO = null;
    ...
    public static ParticipantsDAO getInstance() {
        if (participantDAO == null) {
            participantDAO = new ParticipantsDAO();
        }
    ...
    public HashMap<Integer, Participant> selectAllParticipant() {
